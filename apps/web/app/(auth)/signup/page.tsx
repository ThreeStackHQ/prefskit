      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Create your PrefsKit account — no credit card required
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
          ...
          <button
            type="button"
            className="w-full bg-sky-600 text-white py-2.5 rounded-lg text-sm font-semibold hover:bg-sky-700 transition-colors"
          >
            Create account
          </button>
